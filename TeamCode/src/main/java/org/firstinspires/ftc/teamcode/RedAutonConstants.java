...
@Config
public class RedAutonConstants {

    // Kevin's values
    public static int color_lower_h = 0;
    public static int color_upper_h = 15;
    public static int color_lower_s = 150;
    ...
    public static int kernelSize = 6;
