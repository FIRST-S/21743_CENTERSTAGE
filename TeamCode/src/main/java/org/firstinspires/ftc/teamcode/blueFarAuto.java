...
@Autonomous (name="Blue Far Auton", group="Robot")
...
//        backRightDrive.setDirection(DcMotorSimple.Direction.REVERSE);
    ...
    private void initializeVision() {
         ...
         */
        webcam.setPipeline(new OurOpenCVPipeline2());
        /*
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            if (aprilTagValue == 2) {
                ...
                drive(350, 350, 350, 350, .5);
                drive(1075, -1075, 1075, -1075, .5);
            ...
            sleep(500);
            drive(-20, -20, -20, -20, .2);
            if (aprilTagValue == 2) { // scoring at the backboard
                drive(945, -945, 945, -945, .5);
                drive(3800, 3800, 3800, 3800, .5);
                drive(1000, -1000, 1000, -1000, .5);
                drive(900, 900, 900, 900, .5);
            } else if (aprilTagValue == 1) {
                drive(815, -815, 815, -815, .5);
                drive(3800, 3800, 3800, 3800, .5);
                drive(1000, -1000, 1000, -1000, .5);
                drive(1150, 1150, 1150, 1150, .5);
                ...
                drive(3800, 3800, 3800, 3800, .5);
                drive(1000, -1000, 1000, -1000, .5);
                drive(1300, 1300, 1300, 1300, .5);
            }
            drive(-925, 925, -925, 925, .5);
            arm.setTargetPosition(-200);
            drive(600, 600, 600, 600, .1);
            intake.setPosition(.8);
            sleep(500);
            drive(-340, -340, -340, -340, .2);
...
class OurOpenCVPipeline2 extends OpenCvPipeline {
